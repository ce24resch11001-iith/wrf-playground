...
This guide summarizes the most common issues encountered while installing and compiling WRF, WRF-Chem, and WPS on Linux and HPC systems, ordered roughly from most frequently encountered to least frequent.
...
WRF or WPS cannot locate required libraries during configuration or compilation.
...
Ensure NetCDF-C and NetCDF-Fortran are installed correctly.

---

# 3. Compiler and MPI Mismatch
...
# 4. Dirty Source Tree After Failed Compilation
...
# 5. Compilation Completes but Executables Are Missing
...
# 7. Jasper and GRIB2 Support Issues
...
# 8. WRF-Chem Not Enabled

## Error

WRF compiles successfully but chemistry options are unavailable.
...
# 9. Flex Not Found During WRF-Chem Compilation
...
# 10. Missing Chemistry Source Dependencies
...
These errors are usually caused by stale dependency information after failed or interrupted WRF-Chem builds.
